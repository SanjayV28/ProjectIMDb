...
csvfile = "title.basics.csv"
parquetfile = "title.basics.parquet"
dataset_file = "title.basics.tsv"
...
with DAG(
    ...
    format_to_parquet_task = PythonOperator(
        ...
        op_kwargs={
            "src_file": f"{path_to_local_home}/{csvfile}",
        },
    )
    ...
    QUERY = f"""
                CREATE OR REPLACE TABLE sanjay-fp-de.raw.titlebasics \
