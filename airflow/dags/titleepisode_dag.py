...
dataset_file = "title.episode.tsv"
dataset = "title.episode.tsv.gz"
...
with DAG(
    ...
    QUERY = f"""
        CREATE OR REPLACE TABLE sanjay-fp-de.raw.titleepisode \
        CLUSTER BY tconst, parentTconst  AS \
        SELECT * FROM `{PROJECT_ID}.{BIGQUERY_DATASET}.externaltitleepisode`;
        """
